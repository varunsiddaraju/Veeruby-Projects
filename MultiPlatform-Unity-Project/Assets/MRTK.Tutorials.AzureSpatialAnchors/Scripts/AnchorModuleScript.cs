...
public class AnchorModuleScript : MonoBehaviour
{
    ...
    public GameObject ObjectToBeAnchored;
    ...
    void Start()
    {
        ...
        StartCoroutine(StartAzureSessionCoroutine());
    ...
    public IEnumerator StartAzureSessionCoroutine()
    {
        Debug.Log(1);
    ...
    public async void StartAzureSession()
    {
        ...
        GetSharedAzureAnchorID();

        InvokeRepeating("CheckCurrentAzureAnchorID", 5f, 0);
    }
    ...
    void CheckCurrentAzureAnchorID()
    {
        if (currentAzureAnchorID == null || currentAzureAnchorID == "")
        {
            StartCoroutine(CreateAzureAnchorCoroutine());
    ...
    public IEnumerator CreateAzureAnchorCoroutine()
    {
        yield return new WaitForSeconds(30f);
        Debug.Log("Starting azure anchor creation process...");
        Debug.Log(ObjectToBeAnchored);
        CreateAzureAnchor(ObjectToBeAnchored);
